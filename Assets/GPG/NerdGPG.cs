...
public class NerdGPG : MonoBehaviour {
	...
	public const string appID = "729457695233";
	public string[] str = {"","","",""};
...
#region GPGCallbacks
    ...
    public void OnGPGCloudLoadResult(string result)
    {
        ...
        if (resArr[0] == "success") {
            ...
            str[keyNum] = System.Text.Encoding.Unicode.GetString(data);

            Debug.Log("Data read for key " + resArr[1] + " is " + str[0] + " with len " + resArr[2] + " and converted string length is " + str.Length);
        }
    }
